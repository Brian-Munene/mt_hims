...
if not clinic:
    clinic = Clinic.objects.create(name="Test Clinic", registration_number="TEST1234")

data = {
    "clinic": str(clinic.id),
    "license_number": "DOC-9999",
    "specialty": "Cardiology",
    "user_data": {
        "email": "testdoc9999@example.com",
...
if serializer.is_valid():
    try:
        ...
        print("Success!", profile.user.email)
