  ...
  return (
    <div className="space-y-2">
      <Button
        ...
        disabled={isPending}
        onClick={() => {
          if (!window.confirm("Delete this patient record? This action cannot be undone.")) {
            return;
          }
          ...
          startTransition(async () => {
            try {
              await browserRequest(`/api/proxy/api/patients/patients/${patientId}/`, {
                method: "DELETE",
              });
              ...
              setError(cause instanceof Error ? cause.message : "Unable to delete patient.");
            }
          });
        }}
      >
